...
//	//ServletException은 HttpServlet의 부모이다.	
//		/*
...
//        */
//		//post는 사용자의 입력값을 안보이게 함 (보안)
//		//사용자 요청이 service 매개변수에 저장됨.
//		
//		/*
//		//요청은 request로!
//		//요청 방식이 뭐니? 
//		String method = request.getMethod(); //String 타입임
//		
//		//요청 URI가 뭐니?
...
//	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //doGet과 마찬가지로 내장객체 request와 response를 매개값으로 받습니다.
	 	//post방식으로 요청이 들어왔을 때, 함께 전송된 파라미터를 얻으실 때 
		//인코딩 작업을 다시 거치셔야 합니다.
		
		req.setCharacterEncoding("UTF-8"); //인코딩 과정 !
	...
	@Override
	public void destroy() {
		//서블릿 객체가 소멸될 떄 호출되는 메서드 (객체 소멸 시 1회 자동 호출)
		//대부분 객체 반납이나 소멸 들에 사용. 
